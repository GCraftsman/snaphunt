...
import { Users, Timer, Lock } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="text-center space-y-8 animate-pulse">
           <h1 className="text-[12rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-primary to-secondary leading-none">
             {countdownValue}
           </h1>
      ...
      <div className="w-full max-w-4xl space-y-6">
        <header className="text-center py-8">
          <div className="flex justify-center mb-4">
             {isLocked ? (
               <Badge variant="destructive" className="border-destructive/50 text-destructive-foreground px-4 py-1 text-lg">
                 <Lock className="w-4 h-4 mr-2" /> TEAMS LOCKED
               </Badge>
             ) : (
               <Badge variant="outline" className="border-primary text-primary px-4 py-1">WAITING FOR HOST TO START</Badge>
             )}
          </div>
          <h1 className="text-4xl md:text-5xl font-black mb-2">PICK YOUR SQUAD</h1>
